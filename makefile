...
objects = ec_main.o read.o parse.o env.o lib.o registers.o stack.o llh.o print.o mem.o
...
read.o : read.c read.h parse.h lib.h objects.h
	$(make_obj) read.c parse.c lib.c
