...
#define COMPILED_CODE_BODY                                                     \
    ...
    COMPILED_12:                                                               \
    print_info("COMPILED_12");                                                 \
    cont = LABELOBJ(_AFTER_CALL_13);                                           \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_11:                                                               \
    print_info("COMPOUND_11");                                                 \
    cont = LABELOBJ(_AFTER_CALL_13);                                           \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_10:                                                              \
    print_info("PRIMITIVE_10");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_13:                                                             \
    print_info("AFTER_CALL_13");                                               \
    restore(env);                                                              \
    restore(cont);                                                             \
    if (isTrue(val)) goto TRUE_BRANCH_7;                                       \
    FALSE_BRANCH_8:                                                            \
    print_info("FALSE_BRANCH_8");                                              \
    ...
    COMPILED_16:                                                               \
    print_info("COMPILED_16");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_15:                                                               \
    print_info("COMPOUND_15");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_14:                                                              \
    print_info("PRIMITIVE_14");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_17:                                                             \
    print_info("AFTER_CALL_17");                                               \
    TRUE_BRANCH_7:                                                             \
    print_info("TRUE_BRANCH_7");                                               \
    val = lookup(NAMEOBJ("total"), env);                                       \
    goto CONTINUE;                                                             \
    AFTER_IF_9:                                                                \
    print_info("AFTER_IF_9");                                                  \
    AFTER_LAMBDA_6:                                                            \
    print_info("AFTER_LAMBDA_6");                                              \
    ...
    COMPILED_20:                                                               \
    print_info("COMPILED_20");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_19:                                                               \
    print_info("COMPOUND_19");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_18:                                                              \
    print_info("PRIMITIVE_18");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_21:                                                             \
    print_info("AFTER_CALL_21");                                               \
    AFTER_LAMBDA_4:                                                            \
    print_info("AFTER_LAMBDA_4");                                              \
    ...
    COMPILED_29:                                                               \
    print_info("COMPILED_29");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_28:                                                               \
    print_info("COMPOUND_28");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_27:                                                              \
    print_info("PRIMITIVE_27");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_30:                                                             \
    print_info("AFTER_CALL_30");                                               \
    TRUE_BRANCH_24:                                                            \
    print_info("TRUE_BRANCH_24");                                              \
    ...
    goto CONTINUE;                                                             \
    AFTER_IF_26:                                                               \
    print_info("AFTER_IF_26");                                                 \
    AFTER_LAMBDA_23:                                                           \
    print_info("AFTER_LAMBDA_23");                                             \
    ...
    COMPILED_38:                                                               \
    print_info("COMPILED_38");                                                 \
    cont = LABELOBJ(_AFTER_CALL_39);                                           \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_37:                                                               \
    print_info("COMPOUND_37");                                                 \
    cont = LABELOBJ(_AFTER_CALL_39);                                           \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_36:                                                              \
    print_info("PRIMITIVE_36");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_39:                                                             \
    print_info("AFTER_CALL_39");                                               \
    restore(env);                                                              \
    restore(cont);                                                             \
    if (isTrue(val)) goto TRUE_BRANCH_33;                                      \
    FALSE_BRANCH_34:                                                           \
    print_info("FALSE_BRANCH_34");                                             \
    ...
    COMPILED_42:                                                               \
    print_info("COMPILED_42");                                                 \
    cont = LABELOBJ(_AFTER_CALL_43);                                           \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_41:                                                               \
    print_info("COMPOUND_41");                                                 \
    cont = LABELOBJ(_AFTER_CALL_43);                                           \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_40:                                                              \
    print_info("PRIMITIVE_40");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_43:                                                             \
    print_info("AFTER_CALL_43");                                               \
    arglist = CONS(val, NULLOBJ);                                              \
    restore(env);                                                              \
    save(arglist);                                                             \
    func = lookup(NAMEOBJ("car"), env);                                        \
    ...
    goto CONTINUE;                                                             \
    TRUE_BRANCH_33:                                                            \
    print_info("TRUE_BRANCH_33");                                              \
    val = lookup(NAMEOBJ("list2"), env);                                       \
    goto CONTINUE;                                                             \
    AFTER_IF_35:                                                               \
    print_info("AFTER_IF_35");                                                 \
    AFTER_LAMBDA_32:                                                           \
    print_info("AFTER_LAMBDA_32");                                             \
    ...
    COMPILED_53:                                                               \
    print_info("COMPILED_53");                                                 \
    cont = LABELOBJ(_AFTER_CALL_54);                                           \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_52:                                                               \
    print_info("COMPOUND_52");                                                 \
    cont = LABELOBJ(_AFTER_CALL_54);                                           \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_51:                                                              \
    print_info("PRIMITIVE_51");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_54:                                                             \
    print_info("AFTER_CALL_54");                                               \
    restore(env);                                                              \
    restore(cont);                                                             \
    if (isTrue(val)) goto TRUE_BRANCH_48;                                      \
    FALSE_BRANCH_49:                                                           \
    print_info("FALSE_BRANCH_49");                                             \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    save(func);                                                                \
    func = lookup(NAMEOBJ("cdr"), env);                                        \
    val = lookup(NAMEOBJ("rest"), env);                                        \
    ...
    COMPILED_57:                                                               \
    print_info("COMPILED_57");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_56:                                                               \
    print_info("COMPOUND_56");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_55:                                                              \
    print_info("PRIMITIVE_55");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_58:                                                             \
    print_info("AFTER_CALL_58");                                               \
    TRUE_BRANCH_48:                                                            \
    print_info("TRUE_BRANCH_48");                                              \
    val = lookup(NAMEOBJ("result"), env);                                      \
    goto CONTINUE;                                                             \
    AFTER_IF_50:                                                               \
    print_info("AFTER_IF_50");                                                 \
    AFTER_LAMBDA_47:                                                           \
    print_info("AFTER_LAMBDA_47");                                             \
    defineVar(NAMEOBJ("loop"), val, env);                                      \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    val = lookup(NAMEOBJ("items"), env);                                       \
    arglist = CONS(val, NULLOBJ);                                              \
    ...
    COMPILED_61:                                                               \
    print_info("COMPILED_61");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_60:                                                               \
    print_info("COMPOUND_60");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_59:                                                              \
    print_info("PRIMITIVE_59");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_62:                                                             \
    print_info("AFTER_CALL_62");                                               \
    AFTER_LAMBDA_45:                                                           \
    print_info("AFTER_LAMBDA_45");                                             \
    ...
    COMPILED_72:                                                               \
    print_info("COMPILED_72");                                                 \
    cont = LABELOBJ(_AFTER_CALL_73);                                           \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_71:                                                               \
    print_info("COMPOUND_71");                                                 \
    cont = LABELOBJ(_AFTER_CALL_73);                                           \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_70:                                                              \
    print_info("PRIMITIVE_70");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_73:                                                             \
    print_info("AFTER_CALL_73");                                               \
    restore(env);                                                              \
    restore(cont);                                                             \
    if (isTrue(val)) goto TRUE_BRANCH_67;                                      \
    FALSE_BRANCH_68:                                                           \
    print_info("FALSE_BRANCH_68");                                             \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    save(cont);                                                                \
    save(func);                                                                \
    func = lookup(NAMEOBJ("cdr"), env);                                        \
    ...
    COMPILED_80:                                                               \
    print_info("COMPILED_80");                                                 \
    cont = LABELOBJ(_AFTER_CALL_81);                                           \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_79:                                                               \
    print_info("COMPOUND_79");                                                 \
    cont = LABELOBJ(_AFTER_CALL_81);                                           \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_78:                                                              \
    print_info("PRIMITIVE_78");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_81:                                                             \
    print_info("AFTER_CALL_81");                                               \
    restore(arglist);                                                          \
    arglist = CONS(val, arglist);                                              \
    restore(func);                                                             \
    val = applyPrimitive(func, arglist);                                       \
    ...
    COMPILED_84:                                                               \
    print_info("COMPILED_84");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_83:                                                               \
    print_info("COMPOUND_83");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_82:                                                              \
    print_info("PRIMITIVE_82");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_85:                                                             \
    print_info("AFTER_CALL_85");                                               \
    TRUE_BRANCH_67:                                                            \
    print_info("TRUE_BRANCH_67");                                              \
    ...
    COMPILED_76:                                                               \
    print_info("COMPILED_76");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_75:                                                               \
    print_info("COMPOUND_75");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_74:                                                              \
    print_info("PRIMITIVE_74");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_77:                                                             \
    print_info("AFTER_CALL_77");                                               \
    AFTER_IF_69:                                                               \
    print_info("AFTER_IF_69");                                                 \
    AFTER_LAMBDA_66:                                                           \
    print_info("AFTER_LAMBDA_66");                                             \
    defineVar(NAMEOBJ("loop"), val, env);                                      \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    val = lookup(NAMEOBJ("items"), env);                                       \
    arglist = CONS(val, NULLOBJ);                                              \
    ...
    COMPILED_88:                                                               \
    print_info("COMPILED_88");                                                 \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_87:                                                               \
    print_info("COMPOUND_87");                                                 \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_86:                                                              \
    print_info("PRIMITIVE_86");                                                \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_89:                                                             \
    print_info("AFTER_CALL_89");                                               \
    AFTER_LAMBDA_64:                                                           \
    print_info("AFTER_LAMBDA_64");                                             \
    ...
    COMPILED_99:                                                               \
    print_info("COMPILED_99");                                                 \
    cont = LABELOBJ(_AFTER_CALL_100);                                          \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_98:                                                               \
    print_info("COMPOUND_98");                                                 \
    cont = LABELOBJ(_AFTER_CALL_100);                                          \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_97:                                                              \
    print_info("PRIMITIVE_97");                                                \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_100:                                                            \
    print_info("AFTER_CALL_100");                                              \
    restore(env);                                                              \
    restore(cont);                                                             \
    if (isTrue(val)) goto TRUE_BRANCH_94;                                      \
    FALSE_BRANCH_95:                                                           \
    print_info("FALSE_BRANCH_95");                                             \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    save(cont);                                                                \
    save(func);                                                                \
    func = lookup(NAMEOBJ("cdr"), env);                                        \
    ...
    COMPILED_103:                                                              \
    print_info("COMPILED_103");                                                \
    cont = LABELOBJ(_AFTER_CALL_104);                                          \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_102:                                                              \
    print_info("COMPOUND_102");                                                \
    cont = LABELOBJ(_AFTER_CALL_104);                                          \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_101:                                                             \
    print_info("PRIMITIVE_101");                                               \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_104:                                                            \
    print_info("AFTER_CALL_104");                                              \
    restore(arglist);                                                          \
    arglist = CONS(val, arglist);                                              \
    restore(func);                                                             \
    restore(cont);                                                             \
    ...
    COMPILED_107:                                                              \
    print_info("COMPILED_107");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_106:                                                              \
    print_info("COMPOUND_106");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_105:                                                             \
    print_info("PRIMITIVE_105");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_108:                                                            \
    print_info("AFTER_CALL_108");                                              \
    TRUE_BRANCH_94:                                                            \
    print_info("TRUE_BRANCH_94");                                              \
    val = lookup(NAMEOBJ("result"), env);                                      \
    goto CONTINUE;                                                             \
    AFTER_IF_96:                                                               \
    print_info("AFTER_IF_96");                                                 \
    AFTER_LAMBDA_93:                                                           \
    print_info("AFTER_LAMBDA_93");                                             \
    defineVar(NAMEOBJ("loop"), val, env);                                      \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    ...
    COMPILED_111:                                                              \
    print_info("COMPILED_111");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_110:                                                              \
    print_info("COMPOUND_110");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_109:                                                             \
    print_info("PRIMITIVE_109");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_112:                                                            \
    print_info("AFTER_CALL_112");                                              \
    AFTER_LAMBDA_91:                                                           \
    print_info("AFTER_LAMBDA_91");                                             \
    defineVar(NAMEOBJ("fold-left"), val, env);                                 \
    val = COMPOBJ(_ENTRY_113, env);                                            \
    goto AFTER_LAMBDA_114;                                                     \
    ENTRY_113:                                                                 \
    print_info("ENTRY_113");                                                   \
    env = COMPENVOBJ(func);                                                    \
    unev = parse("nums\n");                                                    \
    env = extendEnv(unev, arglist, env);                                       \
    ...
    COMPILED_117:                                                              \
    print_info("COMPILED_117");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_116:                                                              \
    print_info("COMPOUND_116");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_115:                                                             \
    print_info("PRIMITIVE_115");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_118:                                                            \
    print_info("AFTER_CALL_118");                                              \
    AFTER_LAMBDA_114:                                                          \
    print_info("AFTER_LAMBDA_114");                                            \
    defineVar(NAMEOBJ("+"), val, env);                                         \
    val = COMPOBJ(_ENTRY_119, env);                                            \
    goto AFTER_LAMBDA_120;                                                     \
    ENTRY_119:                                                                 \
    print_info("ENTRY_119");                                                   \
    env = COMPENVOBJ(func);                                                    \
    unev = parse("nums\n");                                                    \
    env = extendEnv(unev, arglist, env);                                       \
    func = lookup(NAMEOBJ("fold-left"), env);                                  \
    ...
    COMPILED_123:                                                              \
    print_info("COMPILED_123");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_122:                                                              \
    print_info("COMPOUND_122");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_121:                                                             \
    print_info("PRIMITIVE_121");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_124:                                                            \
    print_info("AFTER_CALL_124");                                              \
    AFTER_LAMBDA_120:                                                          \
    print_info("AFTER_LAMBDA_120");                                            \
    defineVar(NAMEOBJ("*"), val, env);                                         \
    val = COMPOBJ(_ENTRY_125, env);                                            \
    goto AFTER_LAMBDA_126;                                                     \
    ENTRY_125:                                                                 \
    print_info("ENTRY_125");                                                   \
    env = COMPENVOBJ(func);                                                    \
    unev = parse("(n)\n");                                                     \
    env = extendEnv(unev, arglist, env);                                       \
    ...
    COMPILED_132:                                                              \
    print_info("COMPILED_132");                                                \
    cont = LABELOBJ(_AFTER_CALL_133);                                          \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_131:                                                              \
    print_info("COMPOUND_131");                                                \
    cont = LABELOBJ(_AFTER_CALL_133);                                          \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_130:                                                             \
    print_info("PRIMITIVE_130");                                               \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_133:                                                            \
    print_info("AFTER_CALL_133");                                              \
    arglist = CONS(val, NULLOBJ);                                              \
    restore(env);                                                              \
    val = lookup(NAMEOBJ("n"), env);                                           \
    arglist = CONS(val, arglist);                                              \
    ...
    COMPILED_143:                                                              \
    print_info("COMPILED_143");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_142:                                                              \
    print_info("COMPOUND_142");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_141:                                                             \
    print_info("PRIMITIVE_141");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_144:                                                            \
    print_info("AFTER_CALL_144");                                              \
    TRUE_BRANCH_138:                                                           \
    print_info("TRUE_BRANCH_138");                                             \
    val = lookup(NAMEOBJ("total"), env);                                       \
    goto CONTINUE;                                                             \
    AFTER_IF_140:                                                              \
    print_info("AFTER_IF_140");                                                \
    AFTER_LAMBDA_137:                                                          \
    print_info("AFTER_LAMBDA_137");                                            \
    defineVar(NAMEOBJ("loop"), val, env);                                      \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    val = NUMOBJ(1);                                                           \
    arglist = CONS(val, NULLOBJ);                                              \
    ...
    COMPILED_147:                                                              \
    print_info("COMPILED_147");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_146:                                                              \
    print_info("COMPOUND_146");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_145:                                                             \
    print_info("PRIMITIVE_145");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_148:                                                            \
    print_info("AFTER_CALL_148");                                              \
    AFTER_LAMBDA_135:                                                          \
    print_info("AFTER_LAMBDA_135");                                            \
    defineVar(NAMEOBJ("iterative_factorial_compiled"), val, env);              \
    val = COMPOBJ(_ENTRY_149, env);                                            \
    goto AFTER_LAMBDA_150;                                                     \
    ENTRY_149:                                                                 \
    print_info("ENTRY_149");                                                   \
    env = COMPENVOBJ(func);                                                    \
    unev = parse("(n)\n");                                                     \
    env = extendEnv(unev, arglist, env);                                       \
    func = lookup(NAMEOBJ("<"), env);                                          \
    ...
    COMPILED_160:                                                              \
    print_info("COMPILED_160");                                                \
    cont = LABELOBJ(_AFTER_CALL_161);                                          \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_159:                                                              \
    print_info("COMPOUND_159");                                                \
    cont = LABELOBJ(_AFTER_CALL_161);                                          \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_158:                                                             \
    print_info("PRIMITIVE_158");                                               \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_161:                                                            \
    print_info("AFTER_CALL_161");                                              \
    arglist = CONS(val, NULLOBJ);                                              \
    restore(env);                                                              \
    save(arglist);                                                             \
    func = lookup(NAMEOBJ("recursive_fibonacci_compiled"), env);               \
    ...
    COMPILED_156:                                                              \
    print_info("COMPILED_156");                                                \
    cont = LABELOBJ(_AFTER_CALL_157);                                          \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_155:                                                              \
    print_info("COMPOUND_155");                                                \
    cont = LABELOBJ(_AFTER_CALL_157);                                          \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_154:                                                             \
    print_info("PRIMITIVE_154");                                               \
    val = applyPrimitive(func, arglist);                                       \
    AFTER_CALL_157:                                                            \
    print_info("AFTER_CALL_157");                                              \
    restore(arglist);                                                          \
    arglist = CONS(val, arglist);                                              \
    restore(func);                                                             \
    restore(cont);                                                             \
    ...
    COMPILED_171:                                                              \
    print_info("COMPILED_171");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_170:                                                              \
    print_info("COMPOUND_170");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_169:                                                             \
    print_info("PRIMITIVE_169");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_172:                                                            \
    print_info("AFTER_CALL_172");                                              \
    TRUE_BRANCH_166:                                                           \
    print_info("TRUE_BRANCH_166");                                             \
    val = lookup(NAMEOBJ("b"), env);                                           \
    goto CONTINUE;                                                             \
    AFTER_IF_168:                                                              \
    print_info("AFTER_IF_168");                                                \
    AFTER_LAMBDA_165:                                                          \
    print_info("AFTER_LAMBDA_165");                                            \
    defineVar(NAMEOBJ("loop"), val, env);                                      \
    func = lookup(NAMEOBJ("loop"), env);                                       \
    val = NUMOBJ(1);                                                           \
    arglist = CONS(val, NULLOBJ);                                              \
    ...
    COMPILED_175:                                                              \
    print_info("COMPILED_175");                                                \
    val = COMPLABOBJ(func);                                                    \
    goto COMP_LABEL;                                                           \
    COMPOUND_174:                                                              \
    print_info("COMPOUND_174");                                                \
    save(cont);                                                                \
    goto APPLY_COMPOUND;                                                       \
    PRIMITIVE_173:                                                             \
    print_info("PRIMITIVE_173");                                               \
    val = applyPrimitive(func, arglist);                                       \
    goto CONTINUE;                                                             \
    AFTER_CALL_176:                                                            \
    print_info("AFTER_CALL_176");                                              \
    AFTER_LAMBDA_163:                                                          \
    print_info("AFTER_LAMBDA_163");                                            \
...
#define ALL_COMPILED_LABELS                                                    \
    _ENTRY_1, _AFTER_LAMBDA_2, _ENTRY_3, _AFTER_LAMBDA_4, _ENTRY_5,            \
        _AFTER_LAMBDA_6, _TRUE_BRANCH_7, _FALSE_BRANCH_8, _AFTER_IF_9,         \
        _PRIMITIVE_10, _COMPOUND_11, _COMPILED_12, _AFTER_CALL_13,             \
        _PRIMITIVE_14, _COMPOUND_15, _COMPILED_16, _AFTER_CALL_17,             \
        _PRIMITIVE_18, _COMPOUND_19, _COMPILED_20, _AFTER_CALL_21, _ENTRY_22,  \
        _AFTER_LAMBDA_23, _TRUE_BRANCH_24, _FALSE_BRANCH_25, _AFTER_IF_26,     \
        _PRIMITIVE_27, _COMPOUND_28, _COMPILED_29, _AFTER_CALL_30, _ENTRY_31,  \
        _AFTER_LAMBDA_32, _TRUE_BRANCH_33, _FALSE_BRANCH_34, _AFTER_IF_35,     \
        _PRIMITIVE_36, _COMPOUND_37, _COMPILED_38, _AFTER_CALL_39,             \
        _PRIMITIVE_40, _COMPOUND_41, _COMPILED_42, _AFTER_CALL_43, _ENTRY_44,  \
        _AFTER_LAMBDA_45, _ENTRY_46, _AFTER_LAMBDA_47, _TRUE_BRANCH_48,        \
        _FALSE_BRANCH_49, _AFTER_IF_50, _PRIMITIVE_51, _COMPOUND_52,           \
        _COMPILED_53, _AFTER_CALL_54, _PRIMITIVE_55, _COMPOUND_56,             \
        _COMPILED_57, _AFTER_CALL_58, _PRIMITIVE_59, _COMPOUND_60,             \
        _COMPILED_61, _AFTER_CALL_62, _ENTRY_63, _AFTER_LAMBDA_64, _ENTRY_65,  \
        _AFTER_LAMBDA_66, _TRUE_BRANCH_67, _FALSE_BRANCH_68, _AFTER_IF_69,     \
        _PRIMITIVE_70, _COMPOUND_71, _COMPILED_72, _AFTER_CALL_73,             \
        _PRIMITIVE_74, _COMPOUND_75, _COMPILED_76, _AFTER_CALL_77,             \
        _PRIMITIVE_78, _COMPOUND_79, _COMPILED_80, _AFTER_CALL_81,             \
        _PRIMITIVE_82, _COMPOUND_83, _COMPILED_84, _AFTER_CALL_85,             \
        _PRIMITIVE_86, _COMPOUND_87, _COMPILED_88, _AFTER_CALL_89, _ENTRY_90,  \
        _AFTER_LAMBDA_91, _ENTRY_92, _AFTER_LAMBDA_93, _TRUE_BRANCH_94,        \
        _FALSE_BRANCH_95, _AFTER_IF_96, _PRIMITIVE_97, _COMPOUND_98,           \
        _COMPILED_99, _AFTER_CALL_100, _PRIMITIVE_101, _COMPOUND_102,          \
        _COMPILED_103, _AFTER_CALL_104, _PRIMITIVE_105, _COMPOUND_106,         \
        _COMPILED_107, _AFTER_CALL_108, _PRIMITIVE_109, _COMPOUND_110,         \
        _COMPILED_111, _AFTER_CALL_112, _ENTRY_113, _AFTER_LAMBDA_114,         \
        _PRIMITIVE_115, _COMPOUND_116, _COMPILED_117, _AFTER_CALL_118,         \
        _ENTRY_119, _AFTER_LAMBDA_120, _PRIMITIVE_121, _COMPOUND_122,          \
        _COMPILED_123, _AFTER_CALL_124, _ENTRY_125, _AFTER_LAMBDA_126,         \
        _TRUE_BRANCH_127, _FALSE_BRANCH_128, _AFTER_IF_129, _PRIMITIVE_130,    \
        _COMPOUND_131, _COMPILED_132, _AFTER_CALL_133, _ENTRY_134,             \
        _AFTER_LAMBDA_135, _ENTRY_136, _AFTER_LAMBDA_137, _TRUE_BRANCH_138,    \
        _FALSE_BRANCH_139, _AFTER_IF_140, _PRIMITIVE_141, _COMPOUND_142,       \
        _COMPILED_143, _AFTER_CALL_144, _PRIMITIVE_145, _COMPOUND_146,         \
        _COMPILED_147, _AFTER_CALL_148, _ENTRY_149, _AFTER_LAMBDA_150,         \
        _TRUE_BRANCH_151, _FALSE_BRANCH_152, _AFTER_IF_153, _PRIMITIVE_154,    \
        _COMPOUND_155, _COMPILED_156, _AFTER_CALL_157, _PRIMITIVE_158,         \
        _COMPOUND_159, _COMPILED_160, _AFTER_CALL_161, _ENTRY_162,             \
        _AFTER_LAMBDA_163, _ENTRY_164, _AFTER_LAMBDA_165, _TRUE_BRANCH_166,    \
        _FALSE_BRANCH_167, _AFTER_IF_168, _PRIMITIVE_169, _COMPOUND_170,       \
        _COMPILED_171, _AFTER_CALL_172, _PRIMITIVE_173, _COMPOUND_174,         \
        _COMPILED_175, _AFTER_CALL_176
